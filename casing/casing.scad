...
//translate([7,2.5,6])cube([75,30,2]);
...
color( Couleur1,1){
    ...
    translate([14+4,Width-13,Height+0.2-5])cube([40,9,10]);
    translate([14+4,2,Height+0.2-5])cube([40,3,10]);
    translate([7,Width*0.5-2.5,Height+0.2-5])cube([5,5,10]);
    }
}
